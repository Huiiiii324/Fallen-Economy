...
It combines EconomyShopGUI configs with a custom `FallenEconomy.jar` for auctions and buy orders.
...
- `server-root/plugins/FallenEconomy.jar`: custom `/ah` and `/order` plugin.
